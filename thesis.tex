...
% Title Page
\renewcommand{\enTitle}{Crosslingual Acoustic Modeling in Speech Recognition Using Deep Learning}  %英文標題
\renewcommand{\zhTitle}{使用深層學習的語音辨識中的跨語言聲學模型}  %中文標題
...
\renewcommand{\oralDate}{105 年 6 月 27 日}  %口試日期
